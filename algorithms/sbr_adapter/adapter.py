...
class Adapter:
    ...
    def __init__(self, algo='fpmc', epochs=10, params={}, session_key='SessionId', item_key='ItemId'):
    ...
    def fit(self, data):
        ...
        self.instance.train(data, max_iter=max_iterations, min_iterations=min_iterations, progress=progress)
