...
class SessionMF:
    ...
    def __init__( self, factors=100, batch=32, learn='adagrad_sub', learning_rate=0.001, momentum=0.0, regularization=0.5, dropout=0.0, skip=0, samples=2048, activation='linear', objective='bpr_max', epochs=10, shuffle=-1, last_n_days=None, session_key = 'SessionId', item_key= 'ItemId', time_key= 'Time' ):
